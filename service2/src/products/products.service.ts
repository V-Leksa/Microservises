...
export class ProductsService {
    ...
    public async findCache() {
        const data = await this.cacheManager.get('all_products');
        return  { fromCache: !!data, data };
    }
    ...
    public async findAll(): Promise<Product[]> {
        ...
        if (cachedProducts) {
            ...
            console.log('Данные из Redis [all_products]');
        ...
        await this.cacheManager.set('all_products', products, 60000000000);
    ...
    public async getOneById(id: number): Promise<ProductDto> {
        ...
        if (cachedProduct) {
            ...
            console.log(`Данные из Redis [product_${id}]`); 
